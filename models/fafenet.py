...
class FafeNet(nn.Module):
    def __init__(self, input_config):
        ...
        self.layer3 = self._make_layer(ResBlock2, in_channels=192, out_channels=224, stride=2)
        self.layer4 = self._make_layer(ResBlock3, in_channels=224, out_channels=512, stride=2)
        ...
        self.detection_head = DetectionHead(in_channels=512, out_channels=num_det)
        ...
        self.regression_head = RegressionHead(in_channels=512, out_channels=num_regr)
